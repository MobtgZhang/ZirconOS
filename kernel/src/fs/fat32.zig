...
pub const BPB = extern struct {
    jmp_boot: [3]u8 align(1) = .{ 0xEB, 0x58, 0x90 },
    oem_name: [8]u8 align(1) = .{ 'Z', 'I', 'R', 'C', 'O', 'N', ' ', ' ' },
    bytes_per_sector: u16 align(1) = SECTOR_SIZE,
    sectors_per_cluster: u8 align(1) = @intCast(SECTORS_PER_CLUSTER),
    reserved_sectors: u16 align(1) = 32,
    num_fats: u8 align(1) = 2,
    root_entry_count: u16 align(1) = 0,
    total_sectors_16: u16 align(1) = 0,
    media: u8 align(1) = 0xF8,
    fat_size_16: u16 align(1) = 0,
    sectors_per_track: u16 align(1) = 63,
    num_heads: u16 align(1) = 255,
    ...
    root_cluster: u32 align(1) = 2,
    fs_info: u16 align(1) = 1,
    backup_boot_sector: u16 align(1) = 6,
    reserved: [12]u8 align(1) = [_]u8{0} ** 12,
    drive_number: u8 align(1) = 0x80,
    reserved1: u8 align(1) = 0,
    boot_sig: u8 align(1) = 0x29,
    volume_id: u32 align(1) = 0x12345678,
    volume_label: [11]u8 align(1) = .{ 'Z', 'I', 'R', 'C', 'O', 'N', 'O', 'S', ' ', ' ', ' ' },
    fs_type: [8]u8 align(1) = .{ 'F', 'A', 'T', '3', '2', ' ', ' ', ' ' },
};
