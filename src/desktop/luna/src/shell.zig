...
//!
//! Startup sequence mirrors Windows XP explorer.exe:
//! 1. WinLogon authenticates user and creates desktop
//! 2. Shell initializes resource and font loaders
//! 3. Shell initializes GDI compositor with default Luna Blue theme
//! 4. Desktop, taskbar, and start menu components are created
//! 5. Theme loader registers built-in themes (Blue, Olive, Silver)
...
fn registerOsWindows() void {
    ...
    addOsWindow("Command Prompt", 8);
    addOsWindow("PowerShell", 8);
