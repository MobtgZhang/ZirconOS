//! Luna Login Screen
//! Manages user authentication: Windows XP-style welcome screen with
//! gradient blue background, user avatar selection, and session initialization.
...
pub fn getLoginPanelColor() u32 {
    return theme.login_panel_bg;
}

pub fn getBackgroundTop() u32 {
    return theme.login_bg_top;
}

pub fn getBackgroundBottom() u32 {
    return theme.login_bg_bottom;
}
