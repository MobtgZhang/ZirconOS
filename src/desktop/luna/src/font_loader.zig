//! Font Loader — ZirconOS Luna Desktop
//! Catalogues font files from src/fonts/ and provides
//! named accessors for the GDI compositor and text rendering subsystem.
//!
//! Windows XP system font: Tahoma → mapped to Noto Sans from ZirconOSFonts.
//! Font families are divided into:
//!   - Western: Tahoma replacements (Noto Sans, DejaVu Sans, Source Code Pro)
...
fn registerBuiltinFonts() void {
    const F = "src/fonts";
    // Tahoma replacement: Noto Sans (primary UI font for Luna)
