//! Compositor - ZirconOS Luna Desktop GDI Compositor
//! Surface-based compositing engine with alpha blending support.
//! No glass transparency or blur — Luna uses opaque gradient rendering
//! with soft shadows and rounded corners.
//! Each window renders to its own surface; the compositor merges
//! them in Z-order with damage tracking, cursor layer, and
//! VSync-aligned frame presentation.
