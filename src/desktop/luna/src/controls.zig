//! Luna UI Controls
//! Styled UI primitives with Windows XP Luna aesthetic: gradient buttons,
//! warm grey button faces (ECE9D8), 3D borders, and blue selection highlights.
    ...
    pub fn getBackgroundColor(self: *const Button) u32 {
        if (self.is_default) {
            return switch (self.state) {
                ...
                .hover => theme.taskbar_top_edge,
                .pressed => theme.scheme_blue.taskbar_bottom,
