//! Luna Desktop Manager
//! Manages wallpaper (Bliss), desktop icon grid, and right-click context menus.
//! Windows XP desktop icons: My Computer, My Documents, My Network Places,
...
fn addDefaultIcons() void {
    addIcon("My Computer", 0, 0, 1);
    addIcon("My Documents", 0, 1, 2);
    addIcon("My Network Places", 0, 2, 3);
    addIcon("Recycle Bin", 0, 3, 4);
    addIcon("Internet Explorer", 0, 4, 5);
}
