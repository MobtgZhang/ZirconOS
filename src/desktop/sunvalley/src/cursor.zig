//! Sun Valley Cursor Manager
//! Manages cursor state, smooth interpolation, and cursor sprite
//! selection. Implements DWM smooth cursor behavior with adaptive
//! lerp (win11Desktop.md DWM.Cursor configuration).
//!
//! Sun Valley cursors use slightly thicker strokes and rounded tips
//! compared to Fluent, with crystal-blue accent hints.
