...
<p align="center">
  <img src="assets/screenshot-grub.png" alt="GRUB 启动菜单" width="45%" />
  &nbsp;
  <img src="assets/screenshot-zbm.png" alt="ZBM 引导管理器" width="45%" />
</p>
<p align="center"><em>GRUB 菜单 · ZirconOS Boot Manager (ZBM)</em></p>

<p align="center">
  <img src="assets/screenshot-classic.png" alt="Classic 桌面主题" width="45%" />
  &nbsp;
  <img src="assets/screenshot-luna.png" alt="Luna 桌面主题" width="45%" />
</p>
<p align="center"><em>Classic（Windows 2000 风格）· Luna（Windows XP 风格）</em></p>

<p align="center">
  <img src="assets/screenshot-aero.png" alt="Aero 桌面主题" width="45%" />
  &nbsp;
  <img src="assets/screenshot-modern.png" alt="Modern 桌面主题" width="45%" />
</p>
<p align="center"><em>Aero（Vista/7 风格）· Modern（Windows 8 风格）</em></p>
...
每套主题是主仓库内的 Zig 子项目（`src/desktop/<主题名>/`），静态资源在同目录的 `resources/` 下。
...
桌面主题由 `src/config/desktop.conf` 配置选择（编译时嵌入内核）：
